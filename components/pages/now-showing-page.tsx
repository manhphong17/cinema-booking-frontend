...
import { Star, Clock, Users, Calendar, Film, Search, Filter, X, ChevronDown, ChevronLeft, ChevronRight } from "lucide-react"
import { 
  getNowShowingMoviesPaginated,
  type Movie
} from "../../src/api/movies"
...
export function NowShowingPageContent() {
    ...
    const fetchMovies = async (page: number = 1, append: boolean = false) => {
        try {
            ...
            console.log('Sending request to API with filters:', movieFilters)

            const data = await getNowShowingMoviesPaginated(movieFilters)
            
            console.log('Fetched movies:', {
                page: page,
                pageSize: movieFilters.pageSize,
